...
class Activity3 extends Component {
  ...
  splitTime=(time)=> {
    ...
    differArr[1] = Math.floor((differ % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60)) // 时
    ...
    const newList = [differArr[0].substr(0,1),differArr[0].substr(-1),differArr[1].substr(0,1),differArr[1].substr(-1),differArr[2].substr(0,1),differArr[2].substr(-1),differArr[3].substr(0,1),differArr[3].substr(-1)]
    this.setState({
      time: differ - 1000,
  ...
  render () {
    const { fistTypeList,secondTypeList, typeGoodsHeight,differArr,one } = this.state
    return (
      <View>

        <View id='activity3'>
          <View className="activity3-banner">
            <img src="https://iconmall-developer.oss-cn-beijing.aliyuncs.com/png/small/activity3/banner-zhongqiu.jpg" className="banner-img" />
          ...
          <View className="goods-content">
            ...
            <View className="type-goods-wrap">
              <TypeList
                ...
                titleImage={'https://iconmall-developer.oss-cn-beijing.aliyuncs.com/png/small/activity3/type-list1-zhongqiu.png'} 
              />
              <TypeList
                goodsList={secondTypeList}
                titleImage={'https://iconmall-developer.oss-cn-beijing.aliyuncs.com/png/small/activity3/type-list2-zhongqiu.png'} 
              />
              {/* <TypeList 
