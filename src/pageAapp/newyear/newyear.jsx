...
class doubletwelve extends Component {
  ...
  render() {
    ...
    return (
      <View id="activity7">
        {/* <View className='bg'>
          <Image className='bg-img' src='https://iconmall-developer.oss-cn-beijing.aliyuncs.com/png/small/activity9/bg.gif'></Image>
          <Image className='bg-img' src='https://iconmall-developer.oss-cn-beijing.aliyuncs.com/png/small/activity9/bg.gif'></Image>
          <Image className='bg-img' src='https://iconmall-developer.oss-cn-beijing.aliyuncs.com/png/small/activity9/bg.gif' lazyLoad={true}></Image>
          <Image className='bg-img' src='https://iconmall-developer.oss-cn-beijing.aliyuncs.com/png/small/activity9/bg.gif' lazyLoad={true}></Image>
        </View> */}

        <View className="firstScreen">
          {/* <Image className='bg-img' src='https://iconmall-developer.oss-cn-beijing.aliyuncs.com/png/small/activity9/top.gif' lazyLoad={true}></Image> */}
        </View>
        ...
        <View className="coupons" onClick={this.handleToCertificate}>
          <Image
            ...
            src='https://iconmall-developer.oss-cn-beijing.aliyuncs.com/png/small/activity9/coupon2.png'
            lazyLoad={true}
          ></Image>
        </View>
        ...
        <View className="themeStore" onClick={this.handleToExTaxStore(51)}>
          <Image
            className="theme-bg"
            src="https://iconmall-developer.oss-cn-beijing.aliyuncs.com/png/small/activity9/BUY2.png"
            lazyLoad={true}
          ></Image>
          <View className="titleView">
            <Text className='themeName'>双旦限定 必BUY清单</Text>
        ...
        <View className="themeStore" onClick={this.handleToExTaxStore(51)}>
          <Image
            className="theme-bg"
            src="https://iconmall-developer.oss-cn-beijing.aliyuncs.com/png/small/activity9/beauty2.png"
            lazyLoad={true}
          ></Image>
          <View className="titleView">
        ...
        <View className="themeStore" onClick={this.handleToExTaxStore(51)}>
          <Image
            className="theme-bg"
            src="https://iconmall-developer.oss-cn-beijing.aliyuncs.com/png/small/activity9/color2.png"
            lazyLoad={true}
          ></Image>
          <View className="titleView">
        ...
        <View className="themeStore" onClick={this.handleToExTaxStore(51)}>
          <Image
            className="theme-bg"
            src="https://iconmall-developer.oss-cn-beijing.aliyuncs.com/png/small/activity9/fragrance2.png"
            lazyLoad={true}
          ></Image>
          <View className="titleView">
        ...
        {/* <View className="themeStore" onClick={this.handleToStore('1497,1663,1712', '个人护理')}> */}
          <Image
            className="theme-bg"
            src="https://iconmall-developer.oss-cn-beijing.aliyuncs.com/png/small/activity9/nursing2.png"
            lazyLoad={true}
          ></Image>
          <View className="titleView">
        ...
        {/* 宝宝心选 */}
        <View className="themeStore" onClick={this.handleToStore('729,754,755,756,757', '宝宝心选')}>
        {/* <View className="themeStore" onClick={this.handleToStore('117,304,626,650,657', '宝宝心选')}> */}
          <Image
            className="theme-bg"
            src="https://iconmall-developer.oss-cn-beijing.aliyuncs.com/png/small/activity9/baby2.png"
            lazyLoad={true}
          ></Image>
          <View className="titleView">
        ...
        <View className="brandStore">
          <Image
            src="https://iconmall-developer.oss-cn-beijing.aliyuncs.com/png/small/activity9/brand2.png"
        ...
        <View className="activityRule">
          <Image src='https://iconmall-developer.oss-cn-beijing.aliyuncs.com/png/small/activity9/rule2.png' className="rule" lazyLoad={true}></Image>
        </View>
      </View>
    )
  }
