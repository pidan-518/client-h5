...
export default class index extends Component {
  ...
  componentDidMount() {
    // console.log(
    //   this.$router.params.brandId,
    //   // this.$router.params.comid.split(','),
    //   this.$router.params.pageState,
    //   decodeURI(this.$router.params.name)
    // )
    ...
    if (pageState == 0) {
      const comid = this.$router.params.comid.split(',')
    ...
    if (e == 'reset') {
      ...
      this.setState(
        ...
        () => {
          this.$router.params.pageState == 0
            ? this.getGoodsList(
                this.$router.params.comid == undefined
                  ? null
                  : this.$router.params.comid.split(','),
                1
              )
  ...
  config = {
    navigationBarTitleText:
      this.$router.params.name != 'null' ? decodeURI(this.$router.params.name) : '品牌闪购',
  }
