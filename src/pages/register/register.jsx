...
class Register extends Component {
  ...
  // 表单提交事件
  handleSubmit = e => {
    const { password, phone, verCode, imgCodeVal, confirmpassword } = e.detail.value;
    const phoneReg = /^(13[0-9]|14[579]|15[0-3,5-9]|16[6]|17[0135678]|18[0-9]|19[0-9])\d{8}$/;
    if (phone === "") {
      Taro.showToast({
        title: "请输入手机号",
      ...
      Taro.showToast({ title: "请输入图形验证码", duration: 1000, icon: "none"});
      return false;
    } else if (verCode === "") {
      Taro.showToast({
        title: "请输入验证码",
    ...
    return (
      <View id='register'>
        <View className="register-title">
          <Text className="title-txt">请填写以下注册信息</Text><br />
          ...
          <Form onSubmit={this.handleSubmit}>
            <View className="form-item">
              ...
              <View className="form-item-input">
                <Input name="phone" type="text" onInput={ this.handlePhoneVal } placeholder="请输入您的手机号码" adjustPosition="true" />
              </View>
            </View>
            <View className="form-item">
              <View className="form-item-title">
            ...
            <View className="form-item">
              ...
              <View className="form-item-input">
                <Input name="confirmpassword" type="password" placeholder="请输入确认密码" adjustPosition="true" />
              </View>
            </View>
            <View className="form-item-btn">
              <Button className="form-btn" formType="submit">注册</Button>
            </View>
          </Form>
        </View>
      </View>
